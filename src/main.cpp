...
unsigned int nStakeTargetSpacing = 1 * 60; // 60 seconds
...
const string strMessageMagic = "Cryptassist Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cryptassist", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "super duper epic pos machine";
        CTransaction txNew;
        txNew.nTime = 1525842243 ;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525842243 ;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2005968 : 2005968 ;
        ...
        assert(block.hashMerkleRoot == uint256("0x429f69e269fffe005ca37ec095a259fe7596656d3381510738e1dc4ef15e1468"));
