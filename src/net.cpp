...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Cryptassist-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cryptassist " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
                {"Block-Crawler-1", "165.227.210.169"},
                {"Block--Explorer", "167.99.193.143"},
                {"Block-Crawler-2", "167.99.196.247"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("Cryptassist-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Cryptassist-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Cryptassist-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Cryptassist-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cryptassist is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Cryptassist-start");
